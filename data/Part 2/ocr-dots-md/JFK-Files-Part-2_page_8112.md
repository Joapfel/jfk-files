...
) Previously denied in toto under exemption(s) of ________________.
Recommendation and approval required by DCS.

) Segregable portions previously released, excised portions exempted
under __________ of FOIA.
...
) Sustain initial denial in toto under exemption(s) of ________________
( ) ADD exemption(s)
( ) DROP exemption(s)
...
) Deny document in toto under exemption(s) of _______________.
...
During the DDO classification review, this document was marked as SECRET.
