<table>
   ...
   <tr>
    <td>
     DISSEM BY 53 PER ____
    </td>
    <td>
     FILE RID ☐ RET. TO BRANCH ☐ DESTROY ☐ SIG.
    </td>
    <td>
     X-REF TO FILE NO. _______________________________
    </td>
    <td>
    </td>
    <td>
   ...
   <tr>
    <td>
     ACTION EUR 6 #079 CIRA, SECURIT CALPROP CA 5
    </td>
    <td>
     RID COPY
    </td>
    <td>
     INFO: FILE.MR. Rilan, DDP, ADDP, cl, cllc2, clops,
    </td>
    <td colspan="2">
    </td>
   </tr>
