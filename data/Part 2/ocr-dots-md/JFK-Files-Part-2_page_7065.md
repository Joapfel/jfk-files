...
ii. Commentary. The Review Board addressed the issue of whether to postpone or release source names at the same time that it

considered CIA employee names, and encountered the same problems as it had in the review of CIA employee names. As with CIA employee names, CIA was reluctant to provide name-specific evidence to the Review Board, opting instead to offer general principles supporting CIA's request that the Review Board redact all names.
...
The Review Board should consider a variety of factors, including the need to preserve the integrity of intelligence sources and methods, including the use of particular sources or methods, already well known by the public (e.g., that the Soviet Union in Mexico City was mingled during the alleged visit of President Harveywood Johnson), and whether the source or method is either entirely secret, or whether the information it collected constituted a secret.
—Senate Report on Review July 22, 1992
The Review Board should consider the issue of whether to postpone or release source names at the same time that it considered CIA employee names, and encountered the same problems as it had in the review of CIA employee names. As with CIA employee names, CIA was reluctant to provide name-specific evidence to the Review Board, opting instead to offer general principles supporting CIA's request that the Review Board redact all names."
