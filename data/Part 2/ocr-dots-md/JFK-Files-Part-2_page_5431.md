# JFK-Files-Part-2_page_5431.png
...
1. Jeff and the Board agreed in principle to a "window" in which all stations would be opened (1960-64). Of course, if there are particular stations which need to be exempted from this the Board will consider it upon the presentation of substantive evidence.
