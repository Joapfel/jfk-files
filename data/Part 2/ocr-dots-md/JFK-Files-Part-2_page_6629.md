# JFK-Files-Part-2_page_6629.png
...
2. In the Agency's response to the 27 November "Compliance" letter (see reference), we asked the ARBB to prioritize their requests. The ARBB staff has identified CIA-9 as a "priority" request.

3. The initial request is for access not release. We usually limit access to sensitive material to Jeremy Gunn, ARBB General Counsel, and one or two of his staff. If the material is particularly sensitive, access is restricted to Mr. Gunn and/or the Executive Director of the Board, Mr. David Marwell. Gunn, Marwell and all members of the ARBB Staff's CIA team are fully cleared (TS/SCI).
