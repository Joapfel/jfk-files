...
<table>
    <tbody>
        ...
        <tr>
            ...
            <td>SECRET</td>
            <td rowspan="2">REPRODUCTION BY OTHER THAT<br/>ISSUING OFFICE IS PROHIBITED</td>
        </tr>
        <tr>
            <td colspan="4" style="border-top: 1px solid black;"></td>
        </tr>
        <tr>
            <th colspan="2">ADVANCE COPY ISSUED/BOTTTED</th>
