# JFK-Files-Part-2_page_28917.png

Convert to MarkdownINCOMING CORRESPONDENCE ASSIGNMENT
...
INCOMING CORRESPONDENCE ASSIGNMENT
(MAIL AND DISTRIBUTION SUBUNIT)
...
Check if change is for: [x] more than 6 months [ ] '6 months or less
To avoid delay in receipt of checks you should also file a regular change of address notice with your local post office.

Enter date of marriage

2. MARRIAGE Show new name

Enter date of death

3. DEATH

4. DIVORCE OR ANNULMENT OF MARRIAGE (of spouse beneficiary from insured individual)
...
6. CHILD LEGALLY ADOPTED BY

☐ Stepparent ☐ Grandparent ☐ Aunt ☐ Uncle ☐ Other
