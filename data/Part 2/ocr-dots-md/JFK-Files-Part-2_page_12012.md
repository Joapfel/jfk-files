...
f. When an individual can provide more than one type of information, his symbol or identity (if a potential informant, confidential source, panel source, or some of information without a symbol) should be set forth on as many guide cards as possible types of information.

g. The guide card should show the above date and it is to be alongside the name. Symbol number, as the case may be, of the contacting agent to whom a request may for a specific check with the individual,

h. Also, there may be set forth these guide cards: symbol numbers of informants to move outside a division and who still remain excellent sources regarding past activities. They should be declassified from informants to confidential sources or sources of information. If any such individual has moved from a division and is being utilized by the division to procure one has moved and has received a symbol number from the latter division, such designation should be indicated on the guide card.
...
NW 88321 DocId:32989529 Page 1346
