# JFK-Files-Part-2_page_5329.png
...
(S) In addition, the decisions made by the Board at the May meeting will set a precedent for the potentially hundreds of names to come. We have reviewed only the Oswald 201 file and 12 boxes of the JFK sequestered collection. At this point it is impossible to determine the total number of employees mentioned in the JFK collection. For example in Box 48, there is a Position Control Register (155 pages) listing all employees in Far East Division including the Tokyo station.
