# JFK-Files-Part-2_page_12125.png
...
### 4. Files
When active investigation is initiated relative to an individual who has potential as a security confidential source, a initial classification file should be opened and maintained in a pending status until efforts to develop the individual are discontinued. The same procedure should be followed concerning racial confidential sources, the classification being 137. Files may be opened on confidential sources in criminal matters in a manner identical with that for handling criminal informant files in the discretion of the SAC.
