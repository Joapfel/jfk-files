...
K relations : Medical history on all staffers ; or agents if they can get it
Psychological profiles

Training: Train agents, mgs., seys., officers
Run all training centers

Office of Data Processing : Put together programmes used by computers.
...
DRO has central index which x-refs. true names, cryptonyms,
