...
<table>
   ...
   <tr>
    ...
    <td>
     5. Sex: X male (M) female (F)
     <br/>
     Martial Status M Nr. Dependents 2
    </td>
    <td>
     6. CIA Entry Date:
     <br/>
   ...
   <tr>
    ...
    <td>
     8. Acquired By: (1) X Birth (2) Marriage (3) Naturalization
     <br/>
     (4) Other(specify)
     <br/>
   ...
   <tr>
    <td colspan="3" style="border-top: 2px solid black; border-bottom: 1px solid black;">
    </td>
   </tr>
   <tr>
    <td colspan="3">
