# JFK-Files-Part-2_page_4513.png
      ...
      <td rowspan="2">
        <table>
          <tbody>
            ...
            <tr>
              <td colspan="2">CLASSIFICATION<br/>S E C R E T</td>
            </tr>
          </tbody>
        </table>
        ...
        <table>
          <tbody>
            ...
            <tr>
              <td>FROM</td>
              <td>Chief of Station, JMWAVE (CHG 2)</td>
            </tr>
            <tr>
              <td>SUBJECT</td>
              <td>RYBAT/TYPIC/AMWORLD/AMLILAC Report on Activities of AMWORLD</td>
            </tr>
          </tbody>
        </table>

        <div>ACTION REQUIRED - REFERENCES</div>
        <div>ACTION REQUIRED: FYI</div>
        <div>REFERENCE : NONE.</div>

    </tr>
    <tr>
      <td colspan="3">1. AMLILAC/33 obtained the following information from IDEN A and IDEN B, former members of the AMWORLD Group. The date of the information is mid-July 1964.</td>
    </tr>
    <tr>
      <td colspan="3">
