# JFK-Files-Part-2_page_27158.png
...
*Stein noted that the decision as to whether to utilize someone as a double agent is made by the CIA. If the decision is affirmative, the double agent would be handled by t Agency (if he is abroad) or by the FBI (if he is in this country). The only exceptions to this pattern would be where the double Agent is in the United States for only a brief tim or where he has a special relationship with a particular CIA officer.
