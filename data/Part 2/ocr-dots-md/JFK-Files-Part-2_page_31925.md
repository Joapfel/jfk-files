<table>
   ...
   <tbody>
    ...
    <tr>
     <td colspan="3">
      4. REPORT OF FINDINGS LISTED EDUCATION RECORD
     </td>
    </tr>
    <tr>
     <td colspan="3">
    ...
    <tr>
     <td colspan="3">
      ...
      <br/>
      FORM 040109 ONLY THIS PROTECTIVE MARKING IS EXCLUDED FROM AUTOMATIC TERMINATION
     </td>
    </tr>
    <tr>
     <td>
    ...
    <tr>
     <td colspan="3">
      ...
      1 APR 52
      <br/>
      NON-DEFENDABLE USE ONLY (only after data has been entered)
     </td>
    </tr>
   </tbody>
  </table>
