...
<table>
   ...
   <tr>
    ...
    <td colspan="3">
     REVIEW OF STAFF/D COLLATERNAL INFORMATION
    </td>
   </tr>
   <tr>
    <td>
   ...
   <tr>
    <td>
     XX OPERATIONAL AND DIVISION TRACES
    </td>
    <td colspan="3">
   ...
   <tr>
    <td>
     RESULTS OF TECHNICAL INTERROGATIONS
    </td>
    <td colspan="3">
   ...
   <tr>
    <td colspan="4">
     CIA/OA has no information indicating that these references have previously been reviewed; it appears that all others have.
    </td>
   </tr>
   <tr>
    <td colspan="4">
     CIA/OA is otherwise prepared to take action on your request for a POA/OA on
