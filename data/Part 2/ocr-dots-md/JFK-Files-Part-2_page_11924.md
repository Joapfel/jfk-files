# JFK-Files-Part-2_page_11924.png
...
e. Prefix of symbol number consists of appropriate field office teletype abbreviation. Suffix of symbol number will consist of letter "S" for security informant; letters "PSI" for potential security informant; letters "OS" for confidential source.

f. Although source may subsequently furnish information requiring change in designation (e.g., from security to criminal or to racial, etc.), number previously assigned will remain same; however, suffix is to be changed to appropriate letter or letters indicating this change (NY-000-S to NY-000-C or to NY-000-R).
