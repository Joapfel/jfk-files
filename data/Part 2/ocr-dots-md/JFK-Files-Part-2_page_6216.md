...
1. What records are maintained on contract personnel? OP → OS → OMS

## Security

1. For the period between 1955-65, what was the universe of files that OS had on individuals or groups?

2. How are Office of Security records indexed? card to key panel (SAG)

3. What was the function of the Office of Security/Security Research Staff (OS/SRS)? Why were defector records kept in this component? desired point - "CI function"
