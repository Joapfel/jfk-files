...
(f) Upon receipt from Bureau of corrected security index cards with duplicate copy of FD-122 (stamped "Corrected Security Index cards attached. Substitute for cards in file and destroy old cards. Place photograph and description on reverse side of geographical cards."), section to be taken includes:
...
III. Submit original and one copy of FD-128 to Bureau. Submit two copies thereof to office covering subject's new address, enclosing copies of all previous reports, other pertinent records, photograph if available, and security index cards. FD-128 should show full title.
