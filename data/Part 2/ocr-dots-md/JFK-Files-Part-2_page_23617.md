...
7. FYI, in event overthrow of Trujillo military forces will be dispatched immediately to [pre-invasion] positions. On receipt of request from provisional government, and your concurrence, we will [be prepared to join immediately]. If no request is received and there appears to be any danger of communist takeover then decision will be made in Washington whether to intervene regardless. This makes it imperative that a request be obtained if at all possible. End FY

TOP SECRET

HW 50955 DocId:32423505 Page-95
