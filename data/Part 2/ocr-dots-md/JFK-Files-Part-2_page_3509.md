# JFK-Files-Part-2_page_3509.png
...
<table>
   <tr>
    <td>This summary of significant information has not been coordinated outside the Office of Current Intelligence. It does not represent a complete coverage of all current reports received, nor does time permit the complete evaluation of all reports which are included.</td>
   </tr>
  </table>
...
Soviet "coastal defense rockets" now belong to Cuban Army artillery forces, according to a recent speech by Raul Castro; however, Soviets still appear to be involved in the (communications net)which serves the cruise missile system. (Page 1) 24
