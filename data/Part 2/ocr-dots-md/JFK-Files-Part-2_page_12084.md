...
"I recommend that authority be granted to continue (increase, decrease) payments to the above informant up to $ ___ (amount) per ___ (month, week) for services, plus up to $ ___ (amount) per ___ (month, week) for expenses actually incurred for a period of ___ months, effective ___ (date).")

NWI88321 DocID:32989529 Page 1418
