...
The attached files were located in CIC. They are soft (or working) files containing information on Nosenko, Warren Commission and Oswald. It is not clear if the files date from the Warren Commission period, or were created in 1975/76 (latest date of documents) in response to a request for investigation.
