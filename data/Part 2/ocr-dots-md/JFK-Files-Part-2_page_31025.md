...
Central list of cryptonyms - where they're registered - you can
match the cryptonym with the true name. The more sensitive the
asset is, the more difficult it will be to get to true name.

Hard file : Official information
Soft file : includes working papers - anything of record value in
soft file would be deposited in hard file.

Project files : where are approval, decision-making records filed ?

Unofficial file contains: when worked; supervisor's name; type of work done; evaluations
