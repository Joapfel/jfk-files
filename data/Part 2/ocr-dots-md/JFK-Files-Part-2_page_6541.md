...
It is the conclusion of the Committee that the actions outlined in the preceding sections comprise a program which offers promise of meeting and ultimately revealing the progress of Cuba-based Communist subversion in Latin America. Each individual action embodies some element of usefulness in itself, and any combination of actions should generate correspondingly favorable results. There is no profound relationship which demands the combining of any specific set of actions.
