# JFK-Files-Part-2_page_4294.png
...
### 5. Tibet - Status Report [redacted]

Mr. Colby expanded briefly on the paper of the 8th of July, on the status of projected Tibetan agent operations. He emphasized that the trainees will be sent back to India in the very near future, and that discussions will then take place jointly with the Indians as to details of overland infiltration into Tibet. Planning for air drops of agents is being deferred until sufficient operational intelligence can be built up to permit reasonable decisions.[7]

### 6. Guatemala-Covert Annex (Revised) to Internal Defense Plan [redacted]

This annex was noted by the Group. Particular attention was called to the agreed assessment that the Arevalo threat no longer exists.[7]
