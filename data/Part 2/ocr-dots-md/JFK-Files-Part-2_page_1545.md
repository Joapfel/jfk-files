...
<table>
   ...
   <tbody>
    ...
    <tr>
     ...
     <td colspan="5">
      3. INDICATE SHORTHAND SYSTEM USED CHECK (X) APPROPRIATE ITEM ☐ GREGG ☐ SPEEDWRITING ☐ STENOTYPE ☐ OTHER SPECIFY:
     </td>
    </tr>
    <tr>
     <td colspan="9" style="font-weight: bold;">
    ...
    <tr>
     <td>
      1. WAS YOUR SELECTIVE SERVICE CLASSIFICATION CHANGED ☐ YES ☐ NO
     </td>
     <td>
    ...
    <tr>
     <td>
      CHECK PRESEVE OR GUARD ORGANIZATION TO WHICH YOU BELONG ☐ ARMY ☐ NAVY ☐ MARINE CORPS ☐ AIR FORCE ☐ COAST GUARD ☐ NATIONAL GUARD ☐ AIR NATIONAL GUARD
     </td>
     <td colspan="7"></td>
    </tr>
    <tr>
