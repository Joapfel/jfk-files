# JFK-Files-Part-2_page_11092.png
...
IX. In each letter, pertinent information, if available, regarding the seven items listed above must be set out under the appropriate number but the above headings need not be restated. If no pertinent data is available regarding any of the items, you should make the appropriate comment ... for the respective number.

X. All letters requesting authority to interview the subject of a security investigator must be personally approved by the SAC.

XI. One of the requirements of the letter to the Bureau should consist only of the first page of the letter. When unnecessary, the Bureau to issue specific instructions or comments in connection with authorizing an interview, the Bureau will approve the request by placing an appropriate rubber-stamp impression on the single-page copy of the incoming letter and return it by routing slip.
