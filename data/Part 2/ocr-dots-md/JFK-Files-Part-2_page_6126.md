...
It may well be difficult to define "assassination records" in a manner which will cover all relevant documents, and if so, it may be necessary to establish a mechanism by which a case-by-case determination can be made regarding the linkage between the assassination and a particular document.
