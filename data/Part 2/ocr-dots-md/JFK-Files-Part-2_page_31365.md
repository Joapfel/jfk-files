<table>
    ...
    <tr>
        <td colspan="2">PAUL ARNOLD MARRIOTT<br/>Male Born: 5 Jun 15, OK<br/>Lt Col, 513 10 4236FR<br/>Eglin AFB, FL</td>
        <td></td>
    </tr>
    <tr>
        <td colspan="2">REPORT MADE BY SA<br/>JEROME J. CASTELUCIO</td>
        <td>wt</td>
    </tr>
    <tr>
        <td rowspan="2">
            <table>
                <tbody>
                    <tr>
                        <td colspan="2">PERIOD<br/>20-24 September 1969</td>
                        <td>STATUS<br/>RUC</td>
                    </tr>
                    <tr>
                        <td>OFFICE OF ORIGIN<br/>OSI DIST 7</td>
                        <td>REPORT MADE AT<br/>OSI DIST 50</td>
                        <td>FILE NO.<br/>07D18-1</td>
                    </tr>
                </tbody>
            </table>
        </td>
    ...
    <tr>
        ...
        <td>
            <table>
                <tbody>
                    <tr>
                        <td>DO 7 (Comdr, Eglin AFB-<br/>Action-2)</td>
                        <td>4</td>
                    ...
                    <tr>
                        <td>DO 51</td>
                        <td>2</td>
                        <td rowspan="2">ROBERT B. PRITCHARD, Lt Col, USAF<br/>Deputy Commander</td>
                    </tr>
                    <tr>
                        <td>Dep Dir OSI (PACAF)</td>
                        <td>2</td>
                    </tr>
                    <tr>
                        <td>DIR OSI</td>
                        <td>2</td>
                        <td rowspan="2">Reviewed By AFOSI<br/>For Public Disclosure<br/>In Accordance With<br/>JFKARCA, 1992 JDB<br/>14 AUG 95</td>
                    </tr>
                    <tr>
