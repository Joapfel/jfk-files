...
1c ☐ Married filing separately. If spouse is also filing a return, enter her (his) social security number in space provided above and give first name here

1d ☐ Unmarried Head of Household

1e ☐ Surviving widow(er) with dependent child

Your Exemptions Regular 65 or over Blind

2a Yourself . . . ☑ ☐ Enter number of boxes checked ▷ 2

2b Spouse . . . ☑ ☐

3a First names of your dependent children who lived with you Fred, Brian Elisa, Thomas Enter number ▾ 4

3b Number of other dependents (from page 2, Part I, line 3) ▾

4 Total exemptions claimed . . . . . . . ▾ 6

**Income**
If joint return include all income of both husband and wife

Find tax from table —OR—

Figure tax using tax rate schedules

**Your Tax, Credits, and Payments**
