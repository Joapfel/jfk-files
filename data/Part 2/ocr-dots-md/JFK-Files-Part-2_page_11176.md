...
The full and correct name and aliases of the subject must be contained on the security index card. When the true name of a subject or any aliases are changed, added, deleted, or are found to be incorrect, form FD-122 must be submitted showing *all* correct data to be placed on the security index card.
...
(All others including Orientals (except Chinese),
