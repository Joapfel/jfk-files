# JFK-Files-Part-2_page_13176.png

Convert to Markdown# INSTRUCTIONS
...
* If additions (as when a copy of document sent, to SSG is later sent to HSC) or changes to a previously submitted form are necessary, submit a copy of the original abstract, with the change indicated.
