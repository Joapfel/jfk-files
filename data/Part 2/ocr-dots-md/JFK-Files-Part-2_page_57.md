...
To process the Operational Approval, full information (completed PRQ Parts I and II) must be submitted as soon as possible and not later than six (6) months from this date. An Operational Approval will follow when all investigation is completed and upon the receipt of satisfactory PRQ Parts I and II. Cancellation must be requested if use of Subject by interested Divisions changes.

<table><tbody><tr><td>BY</td><td>DATE</td></tr><tr><td>CI/OPERATIONAL APPROVAL AND SUPPORT DIVISION</td><td>31 May 1960 ada</td></tr></tbody></table>

SECRET

101

FORM 7-90 125 USP PREVIOUS EDITIONS.
