...
ReDuairtel 9/17/70, copies not furnished Boston,
...
Enclosure 2/17/70 SP8MACKSAT

HEREIN IS UNCLASSIFIED
Classified by [機密]
DECLASSIFIED ON: 2/17/70

NOTICE: This document may contain sensitive information that requires special handling. Do not distribute or use without proper authorization.

NOTICE: This document may contain sensitive information that requires special handling. DO NOT distribute or use without proper authorization.

NOTICE: This document may contain sensitive information that requires special handling. DO NOT distribute or use without proper authorization.

2 - Chicago (105-10280) Enclosures(154)
2 - Detroit (Enclosures - 5)
2 - Los Angeles (Enclosure)
2 - Milwaukee (Enclosure)
2 - New Orleans (Enclosure)
2 - New York (Enclosures AND FIELD OFFICES advised by R.E.W.N.Y. OUTGOING SLIP(S) OF 11/27/70)
2 - Philadelphia (Enclosure)
2 - San Francisco (100-47327)(Enclosures - 12)
...
<table>
   ...
   <tr>
    ...
    <td>
     - 100-446389 (Davida Fineman) SE CRAFT
    </td>
   </tr>
   <tr>
