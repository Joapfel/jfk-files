<table>
    <tbody>
        ...
        <tr>
            <td></td>
            <td></td>
            <td style="text-align: center; border-top: 1px solid black;">SECRET</td>
            <td></td>
        </tr>
        <tr>
