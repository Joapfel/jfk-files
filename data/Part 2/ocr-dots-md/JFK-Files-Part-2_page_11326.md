...
If at all possible, information to be included should be set out under the basic main headings I, II, or III. However, should there be some pertinent information to report which does not lend itself to the first three parts, it will be permissible to include it in part IV - MISCELLANEOUS.

c. The term "communist" should be interpreted in its broad sense as including persons not only adhering to the principles of the CPUSA itself, but also to such splinter and offshoot groups as the Socialist Workers Party, Progressive Labor, and the like.
