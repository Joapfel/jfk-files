# JFK-Files-Part-1_page_9755.png

Convert to Markdown<table>
   <tr>
    <td>CABLE SECRETARY DISSEMINATION</td>
    <td>CLASSIFIED MESSAGE</td>
    <td>TOTAL COPIES 28</td>
    <td>POUTING AND/OR INITIALS - SEEN BY</td>
   </tr>
   <tr>
   ...
   <tr>
    <td rowspan="2">
     ...
     <br/>
     DISSEMSD BY 76 PERS 8
    </td>
    <td rowspan="2"></td>
    <td rowspan="2"></td>
    <td rowspan="2">
     SECRET (When Filled In) CTRP
   ...
   <tr>
    ...
    <td>FILE RID ☐ RET. TO BRANCH ☐ DESTROY ☐ SEC.</td>
   </tr>
   <tr>
    <td>#325 WH 8 ☐ RID COPY</td>
    <td colspan="3">INFO<br/>FILE VA RAN CIC/09, G/ISA FCHNSG (WA/KO 8)</td>
   </tr>
  </table>
...
| 1. ST 502, 8/25/89, 9, 1973, 8/7/3 | CASE CONTINUES BE SAME AS |
|---|---|
| THAT REPORTED REF B. | |
