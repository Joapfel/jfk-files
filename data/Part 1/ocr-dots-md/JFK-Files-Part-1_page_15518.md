# JFK-Files-Part-1_page_15518.png

Convert to MarkdownPRITY LEOP DIR CITE VIEN 9234
RYSAT WIROGUE
REF IROP 15.03 (C/ A F ON 29.03)

1. VIEW UNABLE PROVIDE CABLE REQUESTED REF FROM ANY REAL SCHOOL.
   DELIVER EFFORT TO SEND CABLE FROM NOTIONAL SCHOOL WOULD BE QUICKLY
   ...
   ENGINEERING FACULTY. MIGHT BE ABLE PROVIDE LETTER ON VIEW TECHNISCHE
...
2. IF VIEW TO ASSIST, NEED BACKGROUND INFO WIROGUE. IF HE IDEN
