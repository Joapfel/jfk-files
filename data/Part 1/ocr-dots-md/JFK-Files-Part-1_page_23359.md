...
(d) As to the principal agent of Project HUMANOID, the following observations are submitted, which will indicate unmistakably the value of this project, and its contribution to the successful activities of the San Jose Station.
...
**Evaluation of information** - The information produced by the agents being handled by HUMANOID is of great value to the station. In addition to his own production, this agents operations are well suited to checking an information received from other sources.
