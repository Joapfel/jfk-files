...
this to be true, it would have been necessary for the
KGB to dispatch NOSENKO with only a highly restricted
number of FCB personnel (including CRIEANOV) aware of
the actual circumstances of the operation. The KGB,
at the same time, would have propagated within and out-
side of the Soviet Intelligence Services the fiction
that NOSENKO was an actual but disloyal KGB officer
and would have supported this fabrication in various
ways ~~(see attached document~~) the reason spread

about the severity of the loss of NOSENKO, etc.).
...
support the bona fides of NOSENKO, a KGB-controlled
source.
