# JFK-Files-Part-1_page_26042.png
...
<table>
   <tr>
    <td rowspan="2">
     ...
     <br/>
     (Always handcarbon a copy of this form.)
     <br/>
   ...
   <tr>
    <td>
     SUBJECT:
     <br/>
     (True name) Luis Clemente Fazatino P SADA G rilea
    </td>
    <td colspan="3">
   ...
   <tr>
    <td rowspan="6">
     CRYPTONYM, Pseudonym, AKA OR ALIAS
     <br/>
     ARTICLE-15
    </td>
    <td colspan="3">
   ...
   <tr>
    <td colspan="3">
     ...
     <br/>
     As a penetration agent into the Venezuelan General Directorate of Police (DIPOL) and as a penetration of the Ministerio delez presidencial special groups.
    </td>
   </tr>
   <tr>
    <td colspan="3">
     ...
     <br/>
     F. SUGGEST "COVER PRETEND" TO BE USED IN CONDUCTING PERSONAL INVESTIGATION OF SUBJECT.
     <br/>
