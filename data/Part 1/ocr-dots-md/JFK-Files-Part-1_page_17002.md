# JFK-Files-Part-1_page_17002.png
...
3. I agree with paragraph 2b of reference. Not only should the personnel of the surveillance team be recruited at the station, but as outlined in paragraph 3 it should be relatively easy to find suitable candidates. For example it is proposed under the new LIEMPTY project (this consists of the remainder of the non-blown LIPSTICKS and the LIJERSEYS) to recruit a physical surveillance team. Two of the station's outstanding indigenous agents, Scantling and Gerende, are under this project and both are capable of spotting, developing, and recruiting agents.

4. I agree with paragraph 3b, c, and d, and believe that Headquarters should make every effort to find an experienced and competent case officer to fill Clover's slot as the outside surveillance case officer.
