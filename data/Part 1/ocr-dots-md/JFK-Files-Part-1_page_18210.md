# JFK-Files-Part-1_page_18210.png

Convert to Markdown<table>
   <tr>
    <td>CONTINUATION OF<br/>DISPATCH</td>
    <td>CLASSIFICATION<br/>SECRET</td>
    <td>CONFIDENTIALITY STATEMENT AND REMOVAL BY REFERENCE TO THE READER IS REQUIRED.</td>
   </tr>
  </table>
...
a. The Dominican PRSC stands as a prime example of CD irresponsibility from the time Caonabo Javier took over Party leadership in the wake of the Dominican Revolution in April 1965. It has collaborated with the entire spectrum of Marxist-lining parties, and moderation of its extreme military in the near future appears unlikely. The PRSC has developed a small but talented cadre of leadership, primarily from the university ranks, and is buttressed by the strongest CLASC affiliate (CASC) in the Hemisphere.
