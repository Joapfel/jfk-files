# JFK-Files-Part-1_page_12129.png
...
Convert to Markdown<table>
    <tbody>
        ...
        <tr>
            <td>SUBJECT</td>
            <td colspan="4">REDWOOD - Ivan Dmitriyevich OBYEDKOV (201-779495)</td>
        </tr>
        <tr>
        ...
        <tr>
            <td>REFERENCES:</td>
            <td colspan="4">
                A. HMMA-26824, 10 August 1965<br/>
        ...
        <tr>
            <td colspan="5">Attachment:<br/>SPR<br/>Photo-released on B.c.</td>
        </tr>
        <tr>
            <td colspan="5">Distribution:<br/>
                1/2 - CSR, w/att. (2 copies), H/W<br/>
                1 - GWR, w/att. (1 copy), H/W
            </td>
        </tr>
        <tr>
            <td colspan="4"></td>
        ...
        <tr>
            <td></td>
            <td colspan="2">HMMA - 27030</td>
            <td colspan="2">26 AUGUST 1965</td>
        </tr>
        <tr>
            <td></td>
