# JFK-Files-Part-1_page_30889.png

Convert to Markdown<table>
    <tbody>
        <tr>
            <td>DISPATCH</td>
            <td>CATION<br/>SECRET</td>
            <td>PROCESSING ACTION</td>
        </tr>
        <tr>
            <td>10<br/>Chief, WH Division</td>
            <td></td>
            <td>MAY BE OPENED LATER</td>
        </tr>
        <tr>
            <td>INFO.</td>
            <td rowspan="2">XX</td>
            <td>NO FURTHER INFORMATION<br/>ONLY QUALIFIED DSS<br/>CAN BE JUGGED INFERRED</td>
        </tr>
        <tr>
        ...
        <tr>
            <td colspan="3">SUBJECT: ADMINS/CONTRACTS<br/>Jeremy K. BENADUM - Retirement</td>
        </tr>
        <tr>
            <td colspan="3">ACTION REQUIRED-SEE REFERENCE</td>
        </tr>
        <tr>
            <td colspan="3">Reference: HEMS-6919</td>
        </tr>
        <tr>
            <td colspan="3">
        ...
        <tr>
            <td colspan="3">
                b) A memo prepared by BENADUM requesting approval for him to retire 31 December 1970, and which is concurred in by the Chief of Station.
            </td>
        </tr>
        <tr>
            <td colspan="3">
        ...
        <tr>
            <td>Distribution:</td>
            <td colspan="2">3 - C/WHD w/atts. herewith</td>
        </tr>
        <tr>
            <td colspan="3">Dexter E. ROSTHDT</td>
        </tr>
        <tr>
            <td>CROSS REFERENCE TO</td>
            <td>U.S. ARMY HOLOCAUST REMEMBERS MY FATHER AND MOTHER</td>
            <td>LAFERRE 11 AUGUST 1944</td>
        </tr>
        <tr>
            <td></td>
            <td>SUBMITTING ANOTHER VERSION OF THE EXISTING SECRET SIGNATURE</td>
            <td>LAFERRE 11 AUGUST 1944</td>
        </tr>
        <tr>
            <td></td>
