...
would be in a position to state that we had no connection with the
plot and had given it no encouragement or backing of any sort.

As a practical matter, however, if prosecution were
pursued, Macferror, and perhaps other defendants, would probably
...
Macferror in connection with violations of his parols. In view
