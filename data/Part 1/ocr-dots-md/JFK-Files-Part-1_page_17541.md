...
e. Telephone conversations which can be monitored from targets of opportunity.
...
d. Coordinate information received from the LIFEAT coverage with other Station operations, and coordinate as necessary with the Station personnel responsible for the parallel LIFEAT operation.

e. Maintain LIFEAT capabilities for mounting operations against targets of opportunity.

f. Maintain supervision over warehouses, equipment, and training of personnel assigned to the LIFEAT operation.
...
b. Project LINOC which supports the principal "outside" Case Officer, David M. WILSTED, is effected in coordination with Project LIFEAT.

c. Coordination with the parallel, but liaison project, LIFENVOY is closely organized within the Station in two fields: (1) the daily checking
