...
1. The operation is large and the resultant psychological gains and losses, depending on many variables, could be extensive. Needless to say, the operation should not be undertaken, even in part, as a 'gesture' or on a 'guarble'.
...
3. Planning of the operation in all its phases should include the Director of RfZ, in order to ensure a well coordinated political warfare program.

**E. Recommendations:**

It is requested that should authority be given to proceed on this balloon-borne food program, each authorization be contingent on the following recommendations:
...
5. That food deliveries into Albania, Bulgaria, Romania and the Baltics not be considered until after the primary operation into Czechoslovakia, Hungary and Poland has proved successful.
