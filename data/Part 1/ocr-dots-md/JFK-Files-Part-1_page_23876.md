<table>
    ...
    <tr>
        <td>INFO</td>
        <td>Chief, KUDESK; Chief, FE, Chief, AF</td>
        <td>XXX</td>
    ...
    <tr>
        ...
        <td></td>
        <td>ONLY QUALIFIED HEADQUARTERS DESK CAN DO INDEXING</td>
        <td></td>
    </tr>
    <tr>
        <td>SUBJECT</td>
        <td>KAPCK<br/>Richard Thomas GIBSON</td>
        <td></td>
        <td>ABSTRACT</td>
        <td></td>
    </tr>
