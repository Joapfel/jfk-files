...
FROM : WB/C/CA/PP
SUBJECT: Request for Convert Payment (Other Than Cash and Treasury Check)
...
1. Payment to Abel Mentre, state of funds (true) status (e.g.) Co-balance, Interest amount $ 20,000
2. Method of Payment
...
(1) Account Name: Abel Mentre
(2) Account Number: Acct. #2 (Acct. #005-227-002)
...
<table>
  <tr>
    <td>GROUP I<br/>Included from envelope<br/>Shipping and documentation fees</td>
  </tr>
</table>
