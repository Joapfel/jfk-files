# JFK-Files-Part-1_page_26639.png
...
Convert to Markdown<table>
   ...
   <tbody>
    <tr>
     ...
     <td></td>
     <td>XX<br/>NO further action<br/>FOR QUALIFIED STATUS<br/>FOR NON-QUALIFIED STATUS</td>
    </tr>
    <tr>
     <td>INFO<br/>Chief of Station, Guatemala City</td>
     <td></td>
     <td></td>
    </tr>
    <tr>
     ...
     <td></td>
     <td>XX<br/>NO FURTHER ACTION</td>
    </tr>
    <tr>
     <td>SUBJECT<br/>Press Expose of Victor Rico Galan's Connection with Yon Sosa</td>
     <td colspan="2"></td>
    </tr>
    <tr>
    ...
    <tr>
     <td colspan="3">Attachments: NOT REQUIRED<br/>Articles As Stated (HEREWITH)</td>
    </tr>
    <tr>
     <td colspan="3">Distribution:<br/>2 - WHD w/atts hw<br/>1 - Guatemala w/atts hw<br/>2 - Files</td>
    </tr>
    <tr>
     <td colspan="3">NOT MICROFILMED</td>
    </tr>
    <tr>
    ...
    <tr>
     <td>BOS 201-78555C</td>
     <td>HMA-28237</td>
     <td>9 February 1966</td>
    </tr>
    <tr>
     <td colspan="2">CLASSIFICATION<br/>SECRET</td>
     <td>201-33647S PPN: P-7354<br/>201-73580 PPH: P-7867</td>
    </tr>
   </tbody>
  </table>
