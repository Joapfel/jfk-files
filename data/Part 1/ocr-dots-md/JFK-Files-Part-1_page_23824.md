...
4. Aliases, nicknames, legal changes (State briefly time, reason and place of use.) ALAN6
...
8. Present residence (Owner, tenant, sub-tenant.) 30, Stockbridge Hall, PRINCE ALBERT ROAD, LONDON, N.W. 2 (tenant)

9. Permanent address (if different from 8.) NA

10. Present occupation (full title, salary etc.) FREELANCE JOURNALIST
...
12. Relatives, friends, correspondents in United States. (Explain relationship) MRS. SADIE THOMAS (grandmother) MR. CLARENCE GIBSON (father)
