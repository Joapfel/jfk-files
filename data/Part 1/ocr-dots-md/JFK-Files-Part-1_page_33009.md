...
(a) AMCHALK-5 is sufficiently courageous to meet AMWOLF-1 in the Cuban Ambassador's office in Madrid, if necessary;
(b) AMWOLF-1 is a trusted colleague and follower of AMGHOST-1. For this reason and in the belief that AMGHOST-1 was awaiting the message, he would find a way to deliver the message unopened to AMGHOST-1; (c) AMGHOST-1 from all available reporting, background material, SI traffic, we have reason to believe that AMGHOST-1 is not held in the confidence of the Soviets nor does he respect their presence in Cuba, a presence which can only be interpreted as promising difficulties for AMGHOST-1; and (d) Bona fides for the originator are contained in a copy of a letter from AMGHOST-2 to her relatives which she signs with the name "PUSHKIN."
