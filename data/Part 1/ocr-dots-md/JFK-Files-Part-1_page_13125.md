<table>
   ...
   <tr>
    ...
    <td>
     ONLY QUALIFIED DATE (AN AUDIT REVIEW IS NECESSARY)
    </td>
   </tr>
   <tr>
    <td colspan="2">
   ...
   <tr>
    <td colspan="4">
     1. ANGLEVE-15 recently received a letter from his mother in Cuba, in which she gave him news of Raul and Roberto POSADA Carriles.
    </td>
   </tr>
   <tr>
    <td colspan="4">
