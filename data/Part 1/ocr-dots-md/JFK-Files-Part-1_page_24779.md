# JFK-Files-Part-1_page_24779.png

Convert to Markdown<table>
    <tr>
        <td>MESSAGE FORM<br>TOTAL COPY:<br><br>SECRET</td>
        <td>
            <table>
                <thead>
                    <tr>
                        <th colspan="2">DISTRIBUTION AND/OR USE NOTICE - SEEN BY</th>
                    </tr>
                </thead>
                <tbody>
                    <tr>
...
BY:_________________ PER:_________________ S:

CONF:

☐ RID COPY

☐ INDEX ☐ DESTROY: ☐ RETURN TO: ____________________ BRANCH: ☐ FILE RID

NO INDEX ☐ FILE IN CS FILE NO.

INFO:

FILE: __________ VS: __________
