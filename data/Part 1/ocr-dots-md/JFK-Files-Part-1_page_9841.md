# JFK-Files-Part-1_page_9841.png

Convert to Markdown<table>
    <tbody>
        <tr>
            <td colspan="4">CABLE SECRETARIAT DISSEMINATION</td>
            <td colspan="2">LIRING-3<br/>TOTAL COPIES 14</td>
        </tr>
        <tr>
            <td colspan="3">PERSONAL NOTIFIED</td>
            <td>SECRET<br/>(When Filed In)<br/>GROUP:<br/>CLAB TO APPEA<br/>CLASS OF<br/>SHEET<br/>PRODUCTION OF THIS COPY FROM SITED</td>
            <td colspan="2"></td>
        </tr>
        <tr>
            <td>ADVANCE COPY ☐</td>
        ...
        <tr>
            <td>BY______ AT _______?</td>
            <td colspan="2"></td>
            <td>MODEL ☐ YES ☐ NO<br/>CLASSIFY TO FILE NO ______<br/>SH-REF TO FILE NO ______<br/>FILE NO ☐ RET TO ______<br/>BRANCH ☐ DESTROY ☐ S/G.</td>
            <td colspan="2"></td>
        </tr>
        <tr>
            <td>DISTRIBUTED BY L.R. PER __________</td>
            <td colspan="2"></td>
            <td>FILE NO ☐ RET TO ______</td>
            <td colspan="2"></td>
        </tr>
        <tr>
            <td>ACTION WH 8 ☑ R/C COPY</td>
            <td colspan="2"></td>
            <td>INFO FILE VRL CUB/CUSA, FI</td>
            <td colspan="2"></td>
        </tr>
    </tbody>
</table>

SECRET 151615Z APR 68 CITE MEXICO CITY 5225 15 Apr 91298-

GUATEMALA CITY INFO DIRECTOR, TEGUCIGALPA

REFS: A. MEXICO CITY 5111 (1, 85161)
B. MEXICO CITY 5141 (1, 86263)

1. UPON RETURN FROM SHORT VACATION, WALKAGE DUE TO PERSONNEL REFERS TO LETTER INDICATED
