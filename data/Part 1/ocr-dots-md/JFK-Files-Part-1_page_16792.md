# JFK-Files-Part-1_page_16792.png
...
Convert to Markdown<table>
  <tr>
    ...
    <td>DISPATCH SYMBOL AND NUMBER<br/>HMMA-36431</td>
  </tr>
</table>

2. The LIENVOYs had originally requested that five (5) of their men be trained. However, upon arrival in Mexico City and just prior to the scheduled beginning of the training they requested that they be permitted to add one man and that two men be included in the class from the Dirección Federal de Seguridad (DFS). In the latter case, they submitted three names but said that only two of the three would be expected to attend the class. As it turned out all three of the latter group turned up, thus bringing the class to nine (9) students, five (5) Army officers, one civilian from the LIENVOY group, and the three DFS men. Following is a list of the trainees:

(1) Felix LOZANO Rangel, DFS, age 35.

(2) Javier MANCERA Fuentes, DFS, age 33.

(3) Esteban GUEVARA Salgado, DFS, age 33.
