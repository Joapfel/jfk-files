# JFK-Files-Part-1_page_14090.png
...
8. The cover correspondence must in so way appear to be different from the bulk of mail ordinarily found in the channel being used. It should contain as information which could be viewed as suspicious in any way. The external aspects of the correspondence must be latent in all aspects if the SW is to be expected to provide any level of security.
...
10. The following supplies and instructions are transmitted in support of the AMR operation:

a. Standard Form (1059-CWI) which describes in detail how to write (with a carbon sheet).
...
c. One (bottle (100 ml.) of developer (20609) which will develop the demonstration (carbon) writing.
...
h. Two practice messages written with AMR's ingoing SW system which he should use to practice his development technique.

i. (Twenty-five pills (56838) which AMR will use to develop the SW messages he receives. Two or three (of these pills) should be used in training. Twenty of the remaining pills) should be issued to the agent.

j. Instruction (Form RA-25053) instructions for the use of (developer (56838)).
