...
This material contains information affecting the National Defense of the United States, within the meaning of the Espenak Law, as amended, and the National Security Act.

<table>
   <tr>
    <td colspan="2">SECRET (This field is filled in)</td>
   </tr>
  </table>
...
<table>
   <tr>
    <td>THIS IS UNEVALUATED INFORMATION. SOURCE GRADINGS ARE DEFINITIVE. APPROVAL OF CONTENT IS TENTATIVE.</td>
   </tr>
  </table>
  ...
  <tbody>
    <tr>
      <td style="vertical-align:top;">
        <div>CLASSIFICATION - DISSEMINATION CONTROLS</div>
        <div><strong>SECRET</strong></div>
      </td>
      <td style="vertical-align:top;">
        <div><img src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAABAAAAAQCAYAAAAf8/9hAAAAAXNSR0IArs4c6QAAAARnQU1BAACxjwv8YQUAAAAJcEhZcwAADsMAAA7DAcdvqGQAAABYSURBVDhPY6AGaAKIAm2zXyN73N0XAAAAAElFTkSuQmCC" /></div>
      </td>
    </tr>
    <tr>
      <td colspan="2">
