<table>
   ...
   <tr>
    ...
    <td></td>
    <td rowspan="2"></td>
    <td>MAKE IT CLEAR, NO ERRORS ALLOWED</td>
    <td></td>
   </tr>
   <tr>
    <td>FROM</td>
    <td>Chief, Domestic Ops Division<br/>Chief, DO Base, New York</td>
    <td></td>
    <td>OFFICE WORKS, MUST BE FINISHED ON TIME</td>
    <td></td>
   </tr>
   <tr>
    <td>SUBJECT</td>
    <td>Chief of Station, JMWAVE<br/>Operational/TYPIC/MIGUILE/AMSTALK<br/>Transmittal of Iden Kit Composites</td>
    <td>C.</td>
    <td></td>
    <td>RECEIVED<br/>DO NOT DELETE</td>
    <td></td>
   </tr>
  </table>
...
References: A. DIRECTOR 49660, 6 Nov 67 AC
...
3. Guillermo's companion, fnu lnu, (composite No. 2) was described by AMSTALK-1 as medium height, heavy stocky build, dark hair, thick lips, and having no distinguishing characteristics such as unusual scars or marks.
