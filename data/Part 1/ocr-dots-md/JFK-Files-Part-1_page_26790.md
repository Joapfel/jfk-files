...
<table border="1" style="border-collapse: collapse; width: 100%;"><tbody><tr><td>TO</td><td>MEXI</td></tr><tr><td>FROM</td><td>DIRECTOR</td></tr><tr><td>CONF</td><td>(WH 8) R/AN, DDL,WHK 8 C/OPS, CA 2, CALPROP, eVdA, VR, FILE, Fl/UT 2, Fls,</td></tr></tbody></table>

| TO | MEXI | INFO | CITE DIR |
|---|---|---|---|
|  | MHSPAWN PBRUMEN |  | 98512 |
...
WH Comment: Refs:
A. L-1 on 30 Mar asked for Sta assistance in story for his mag on subversive activities Sov Bloc Cuban Embassies.
B. L-1 OA specifically limits passago classified information to him.

WH/PO/B
CI/OPS (in draft) Hughes
WH/C/CA (in draft) Soparley, Ld
