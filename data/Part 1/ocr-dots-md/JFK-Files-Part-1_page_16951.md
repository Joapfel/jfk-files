...
g. Raymond H. GERENDE - During the reporting period, GERENDE served as the full-time LIEMPTY P/A, operating as the cutout to the LIMITED, LILYRIC, and LICALLA basehouses and bearing the agent handling responsibility for the related personnel as well as handling the operators of the LIENTRAP mobile unit, LIEMPTY-4, and LIEMPTY-19, a Station asset (translator) carried under Project LIFEAT. Gerende's overall assignment involved at least twelve clandestine agent meetings each week, in addition to his meetings with the LIEMPTY Project case officer. It should be noted that GERENDE also made numerous and essential contributions to the sensitive AMROD deception operation.
