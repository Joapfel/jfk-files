<table>
   ...
   <tr>
    <td>TO</td>
    <td>PRIOR TO COMMUNICATION<br/>NO RECOGNIZABLE RECORDS</td>
   </tr>
   <tr>
   ...
   <tr>
    <td>FROM</td>
    <td>ONLY IF NEEDED<br/>HEADQUARTERS ORDER<br/>CABIN FLOOR DELIVERIES</td>
   </tr>
   <tr>
    <td>Chief of Base, JMWAYNE</td>
    <td>AESTHETICS<br/>RECOMMENDATIONS</td>
   </tr>
   <tr>
    <td>SUBJECT: JMATHE</td>
    <td colspan="2">Transmittal of Memorandum of Oral Commitment for [Alberto PONZOA y Alvarez] 04</td>
   </tr>
   <tr>
    <td colspan="3">ACTION REQUIRED REFERENCE</td>
   </tr>
   <tr>
    <td colspan="3">Process MOC</td>
   </tr>
   <tr>
    <td colspan="3">
