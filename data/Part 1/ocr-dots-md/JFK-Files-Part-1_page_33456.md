# JFK-Files-Part-1_page_33456.png

Convert to Markdown<table>
    <tbody>
        <tr>
            <td>CABLE SEC DISSEMINATED BY</td>
            <td>28 PER TOTAL COPIES</td>
            <td>31-1 RLY BY</td>
            <td rowspan="4" colspan="2">REPRODUCTION BY OTHER THAN<br>ISSUING OFFICE IS PROHIBITED</td>
        </tr>
        <tr>
        ...
        <tr>
            <th colspan="4">ADVANCE COPY ISSUED/SLOTTED BY AT Z</th>
        </tr>
        <tr>
            <th>ACTION UNIT</th>
            <th>1.</th>
            <th>REF. FILE</th>
            <th>VR 10JAN. SSS, P5/E64</th>
            <th colspan="2">AGENCY MESSAGE</th>
        </tr>
        <tr>
            <td>WH/8<br>( circled )</td>
            <td></td>
            <td></td>
            <td></td>
            <td>1</td>
