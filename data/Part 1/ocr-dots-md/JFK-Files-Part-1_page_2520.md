# JFK-Files-Part-1_page_2520.png
...
As to the STORSBERG case, while it cannot at present be proved that the recruitment pitch took place before NOSENKO left for Bulgaria, it can be stated, on the basis of reporting from MORONE, that it had to have taken place before the time NOSENKO returned from Bulgaria.
