...
Convert to Markdown<table>
    ...
    <tr>
        <td>PERSON UNNOTIFIED:</td>
        <td></td>
        <td></td>
    </tr>
    <tr>
        <td colspan="4"></td>
        <td><table border="1" style="width:100%; border-collapse: collapse; text-align:center;">
            <thead>
                <tr>
                    <th style="padding:5px;">STAFF</th>
                </tr>
            </thead>
            <tbody>
                <tr>
    ...
    <tr>
        <td colspan="3">ADVANCE COPY ISSUED:</td>
        <td>BY:</td>
        <td></td>
    </tr>
    <tr>
...
3. INDEX PARSONS, FILE: 75-128-28-201-0285923.
