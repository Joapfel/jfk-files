# JFK-Files-Part-1_page_18143.png
...
Convert to Markdown<table>
    <tbody>
        <tr>
            ...
            <td colspan="2">PROCESSING ACTION<br/><br/>WAITING FOR ENQUIRY<br/><br/>NO INFORMING REQUIRED<br/><br/>ONLY QUALIFIED USER CAN ASK MORE INFORMATION</td>
        </tr>
        <tr>
            <td>TO<br/><br/>Chief, WII</td>
            <td></td>
            <td></td>
            <td colspan="2"></td>
        </tr>
        <tr>
            <td>INFO.<br/><br/>Chief, SB</td>
            <td></td>
            <td></td>
            <td colspan="2"></td>
        </tr>
        <tr>
            <td>FROM<br/><br/>Chief of Station, Mexico City</td>
            <td></td>
            <td></td>
            <td colspan="2">MICROFILM</td>
        </tr>
        <tr>
            <td>SUBJECT<br/><br/>LIEMPTY Properties</td>
            <td colspan="4"></td>
        </tr>
        <tr>
        ...
        <tr>
            <td>REFERENCE: HMMW-15952, 27 November 1967</td>
            <td colspan="4"></td>
        </tr>
        <tr>
            <td colspan="5">
        ...
        <tr>
            <td colspan="5" style="text-align:center;">......continued</td>
        </tr>
        <tr>
            <td>Distribution:</td>
            <td colspan="3">2 - C/ WH, w/att.</td>
            <td></td>
        </tr>
        <tr>
            <td></td>
            <td colspan="3">2 - C/SB, w/att.</td>
            <td></td>
        </tr>
        <tr>
            <td>Attachment:</td>
            <td colspan="4">Identity Sheet (under separate cover)</td>
        </tr>
        <tr>
            <td>CROSS REFERENCE TO</td>
            <td colspan="2">DISPATCH SYMBOL AND NUMBER<br/>HMMA-33814</td>
            <td colspan="2">DATE<br/>8 January 1968</td>
        </tr>
        <tr>
            <td></td>
            <td>CLASSIFICATION<br/>SECRET</td>
            <td></td>
            <td>MOS FILE NUMBER<br/>50-6-74/2</td>
            <td></td>
        </tr>
        <tr>
