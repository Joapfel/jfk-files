# JFK-Files-Part-1_page_16682.png

Convert to MarkdownINFORMATION REPORT

CENTRAL INTELLIGENCE AGENCY

This material contains information affecting the National Defense of the United States within the meaning of the Espionage Law, Title 18, USC Secs. 790 and 794, the transmission or revocation of which in any manner to an unauthorized person is prohibited by law.
...
<table>
   ...
   <tr>
    <td colspan="10">REPCINCLANT I&NS</td>
   </tr>
   <tr>
    <td colspan="10">(Note: Field distribution indicated by "5")</td>
   </tr>
  </table>
...
<table>
  <tbody>
    <tr>
      ...
      <td></td>
      <td></td>
      <td>LX-2307<br/>NP (AMMUG-1)<br/>CS-311/01258-65</td>
      <td></td>
    </tr>
    <tr>
      <td colspan="7">For Distribution See Attached Page</td>
      <td></td>
    </tr>
    <tr>
      <td>CI/LS</td>
      <td colspan="2">13 (for AF/QSI, ACSI, OKI, SY, FBI)</td>
      <td colspan="2">DIA - 2 each</td>
      <td></td>
      <td>COORDINATING RELATIONS</td>
      <td>RJD / RWT<br/>eb</td>
    </tr>
    <tr>
      <td>TOTAL I/F</td>
