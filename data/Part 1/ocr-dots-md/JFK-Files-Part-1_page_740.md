...
<table>
   ...
   <tbody>
    ...
    <tr>
     <td colspan="4">
      01 1. During a recent training period on interrogation with a HUGLIB Case Officer, the point of getting information from suspects on their international contacts or information that might help other services was stressed. Apparently, as a result, the HUGLIB Case Officer dug into his notes on the interrogation of Ricardo Ismael VALLECILLO Perez, Guatemalan FAR member, and came up with the following information which he thought WOFIRM might want to pass to the Mexican Service. 24
     </td>
    </tr>
    <tr>
     <td colspan="4">
    ...
    <tr>
     <td colspan="4">
      3. HUGLIB-10 has given his permission to pass this information to the Mexican Service if it is considered of any value by WOFIRM. 24
     </td>
    </tr>
    <tr>
     <td colspan="4">
...
STAMP: 0503500900289000000000000000
