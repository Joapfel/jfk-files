# JFK-Files-Part-1_page_32880.png
...
<table>
    <tbody>
        <tr>
            <td>INDEX ☐ YES ☐ NO</td>
            <td class="classification">CLASSIFIED MESSAGE</td>
            <td>TOTAL COPIES</td>
            <td rowspan="5">
                SECRET<br/>
                [SECRET MESSAGE BOX]<br/>
                [This image does not contain any text. It is a logo with the words REPRODUCTION PROMIBITED and a secret agent on a secret mission.]<br/>
                <table border="1" style="width:100%; border-collapse: collapse;">
                    <tbody>
                        <tr><td colspan="2">REPRODUCTION PROHIBITED</td></tr>
        ...
        <tr>
            <td>FILE, VR, c/wrk, c/euro, c/o, c/faz, c/ent</td>
            <td colspan="3">[Handwritten notes: See attached files]</td>
        </tr>
    </tbody>
</table>
