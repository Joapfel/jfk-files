# JFK-Files-Part-1_page_8791.png

Convert to Markdown<table>
  <tr>
    <td>ORIG:</td>
    <td>DIANA DAVIS</td>
    <td rowspan="4">ME. S/LE FORM<br/>TOTAL Copies: 22</td>
    <td rowspan="4">
      <table>
        <thead>
          <tr>
...
<table>
  ...
  <tr>
    ...
    <td colspan="4"><input type="checkbox" /> FILE IN CB FILE NO.</td>
  </tr>
</table>
