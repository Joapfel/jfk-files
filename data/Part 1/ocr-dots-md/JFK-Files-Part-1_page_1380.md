<table>
    <tbody>
        ...
        <tr>
            <td colspan="2">3 - C/SAS w/attchs.</td>
        </tr>

        <!-- Section 2: Cross Reference, Security Classification, and De-SENSITIZED -->
        <tr>
            <td style="vertical-align: top;">
                <table>
                    <tbody>
                        <tr><td>CROSS REFERENCE (To be deleted)<br/>Cognacading and<br/>denialization</td></tr>
                        <tr><td>DESENSITIZED</td></tr>
                        <tr><td>PRI CSH 43-43</td></tr>
                    </tbody>
                </table>
            </td>
            <td style="vertical-align: top;">
                <div>CLASSIFICATION: SECRET</div>
                <div>HEADQUARTERS FILE NUMBER: ♦</div>
            </td>
        </tr>
        ...
        <!-- Section 4: PRIORITY -->
        <tr>
            <td colspan="2"><strong>PRIORITY</strong></td>
        </tr>
        <tr>
            <td>ACTION REQUIRED... REFERENCES</td>
            <td>ACTION: Request Headquarters decision on continuation or termination of Project AMTRUNK.</td>
        </tr>
