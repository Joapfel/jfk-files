# JFK-Files-Part-1_page_33064.png

Convert to Markdown<table>
   <tr>
    <td>CONTINUATION OF<br/>DISPATCH</td>
    <td>CLASSIFICATION<br/>SECRET</td>
    <td>DIPATCH SYMBOL AND NUMBER<br/>UFAA-1736</td>
   </tr>
  </table>
...
4. An agent service record for the period subsequent to Reference B is forwarded herewith.
