...
1. Payment to Manuel Antino Buena, CA $275.00 NAME OF PAYEE (True) STATUS (*e.g.*): CASHIER'S INTEGRATION AMOUNT:
...
(4) Bank Address:
Zip:
(5) Transfer: [ ] via Air Mail or [x] Bank Wire
...
4. Indicate preference: [ ] Notify when transaction is complete [x] Check to be picked up
...
FORM 1-00 1964 COMPLETE PREVIOUS EDITIONS

SECRET

<table><tr><td>GROUP I<br/>Included from automatically<br/>deemed and deconfiscated</td></tr></table>
