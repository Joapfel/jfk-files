...
6. Kind and number of additional measures which we would seek in OAS would vary with choice between alternatives, for example, our tentative thinking is that minimum OAS package acceptable to US under Alternative A would be: authorization use force; condemnation Castro regime; and reaffirmation of invigoration anti-subversive measures. Under Alternative B, minimum package now estimated to be: defensive system with search and seizure within national territory; condemnation; reaffirmation anti-subversive measures; and obligatory break in air and surface communications between OAS countries and Cuba.
