# JFK-Files-Part-1_page_8875.png
...
<table>
    <tbody>
        <tr>
            <td colspan="2">NON-OFFICIAL COVER<br>CONCURRENCE</td>
            <td colspan="3" rowspan="2">DATE</td>
        </tr>
        <tr>
            <td colspan="4">TO BE COMPLETED BY CI/OA ONLY</td>
        </tr>
        <tr>
            <td>SUBJECT'S NAME<br>D. B. F. (P) TICHY, Edward C.</td>
            <td>C OR ZOI NO.<br>60-85818 2/93</td>
            <td colspan="3"></td>
        </tr>
        <tr>
            <td>DATE OF BIRTH<br>08-18-93</td>
            <td>PLACE OF BIRTH<br>TALLAHASSEE, FLORIDA</td>
            <td colspan="3"></td>
        </tr>
        <tr>
            <td>CITIZENSHIP<br></td>
            <td>U.S. RESIDENCE<br></td>
            <td colspan="3"></td>
        </tr>
        <tr>
            <td colspan="4">OVERSEAS RESIDENCE</td>
        </tr>
        <tr>
            <td>EMPLOYER<br>Lindsey M. Kirtley, M.D., Ph.D.</td>
            <td>PROJECT<br>LIMBURG</td>
            <td colspan="3"></td>
        </tr>
        <tr>
            <td>DIVISION OR STAFF<br></td>
            <td>CASE OFFICER<br></td>
            <td>ROOM NO.<br></td>
            <td>EXTENSION<br></td>
            <td></td>
        </tr>
        <tr>
            <td colspan="4">PROPOSED USE<br></td>
        </tr>
        <tr>
            <td colspan="4">TO BE COMPLETED BY CCS ONLY</td>
        </tr>
        <tr>
            <td>CCS/NC CASE OFFICER (Extension 5144)</td>
            <td>CCS FILE NO.</td>
            <td colspan="3"></td>
        </tr>
        <tr>
        ...
        <tr>
            <td colspan="5">Distribution: L-CFS L-CF/SA G-AREA DIVISION<br><br>FACULTY FACULTY DEPARTMENT</td>
        </tr>
    </tbody>
</table>
