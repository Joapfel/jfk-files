...
that all possible action not already taken to enhance and
exploit the potential of each source has been considered
and, where appropriate, additional instructions issued to
the field.

It is noted that 10 of the 12 PDA cases referred to
were in a closed status in accordance with recent DID instructions
regarding the administrative handling of all SI and PSI files.
Briefly under these procedures such cases are placed in a
closed status and are reopened only at such time as a justi-
fication letter is due. These criteria will continue to be
