...
DATE 1/18/61 BY SP-2 AL M-K-16
...
FOR GENERAL RELEASE
NOTICE: This document contains confidential information and should not be distributed without written permission from the source. The purpose of this distribution is for internal reference only and may contain sensitive military or technical information. Distribution is restricted to authorized users only.
DATE 1/18/61 BY SP-2 AL M-K-16
CONFIDENTIAL
FOR GENERAL RELEASE
UNCLASSIFIED
