...
2. Materials pertaining to a "no contact list", and any other similar matters such as SAC letter 66-78 dated December 15, 1966, reflecting that Courtney Evans is a person not to be contacted.

3. A list of all "control files", "set-up files", and "functional files" maintained by the FBI Intelligence Division.
