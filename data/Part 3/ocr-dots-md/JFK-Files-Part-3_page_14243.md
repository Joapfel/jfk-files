...
State used the MCB code machine (identical to that used by U. S. military attaches,
1953-1954) which is vulnerable to audio surveillance which can detect the plain
...
traffic of other Iron Curtain U. S. posts using this system. From 1959-1962
(before installation of the electronically shielded code room in the Embassy)
...
emanations from the U. S. 1-time teleprinter in the Embassy (and although this
